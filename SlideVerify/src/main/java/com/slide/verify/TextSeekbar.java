...
class TextSeekbar extends AppCompatSeekBar {
    ...
    public TextSeekbar(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.MySeekbarStyle);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int baseLineY = (int) ((float) getHeight() / 2 - top / 2 - bottom / 2);//基线中间点的y轴计算公式
        canvas.drawText("向右滑动滑块完成拼图", (float) getWidth() / 2, baseLineY, textPaint);
    }
}
